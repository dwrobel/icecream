...
Name:     icecream
%global forgeurl       https://github.com/%{the_owner}/%{name}
...
%global commit         81fbfc2dc21f0669a0a6ada9c94094c3a2b83768
Version:               1.4rc1
%endif
...
#export CXXFLAGS="%{optflags} -U_FORTIFY_SOURCE -O0 -ggdb3 -fsanitize=address -fPIE -fno-omit-frame-pointer"
#export LDFLAGS="%{build_ldflags} -fsanitize=address"
...
%changelog
* Tue Jul 06 2021 Damian Wrobel <dwrobel@ertelnet.rybnik.pl> - 1.4rc1-0.6
- Measure load more accurately
- Increase number of preload jobs
- Remove mangling ggc-min-expand and ggc-min-heapsize options
- Fix BR for rawhide
